...
public interface StudentArrayOperation {
	...
	void add(Student student, int index);
      Student[] thisIsAStudentArray = {"AAA", "BBB", "CCC", "DDD", "EEE"};
	  System.out.println( thisIsAStudentArray[0] );
      System.out.println( thisIsAStudentArray[1] );
      System.out.println( thisIsAStudentArray[2] );
      System.out.println( thisIsAStudentArray[3] );
      System.out.println( thisIsAStudentArray[4] );
	...
	{
	student n1 = new student ("aaa"); 
    System.out.println(nub1);
    studentt n2 = new student ("bbb"); 
    System.out.println(nub2);
    student n3 = new student   ("ccc"); 
    System.out.println(nub3); 
    student n4 = new student("ddd"); 
   ...
   student nub1 = new student ("Griffin"); 
   System.out.println(nub1);
   student nub2 = new student ("Giffin"); 
   System.out.println(nub2);
   student nub3 = new student("Grifin"); 
   System.out.println(nub3); 
   student nub4 = new student ("Griff"); 
   System.out.println(nub4);
